...
function MainApp() {
  ...
  return (
    <div className="h-screen flex flex-col w-full bg-[#edf5f1] text-slate-900" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {!isReaderRoute && (
        <header className="bg-white border-b border-slate-200/80 shrink-0 z-30 shadow-2xs w-full">
          <div className="w-full flex items-center justify-between px-4 lg:px-6 py-3.5 gap-4">
            ...
            <button onClick={() => navigate('/study')} className="flex items-center gap-2.5 group shrink-0 focus-visible:outline-none min-w-0">
              ...
              <div className="flex flex-col md:hidden text-left min-w-0">
                ...
                <span className="text-[14px] font-bold text-slate-900 truncate group-hover:text-indigo-600 transition-colors" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  {user?.name || "Student"} 👋
                </span>
              </div>
            </button>
            ...
            >
              ...
              <input 
                ...
                className="w-full pl-10 lg:pl-12 pr-16 py-2.5 lg:py-3.5 bg-slate-50 border border-slate-200/80 text-slate-800 placeholder:text-slate-400 hover:border-slate-300 focus:outline-none rounded-xl lg:rounded-2xl text-sm lg:text-[16px] xl:text-[17px] font-bold transition-all"
              />
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 shrink-0">
              ...
              <button
                ...
                title="Notifications"
                className="hidden md:flex items-center justify-center w-10 h-10 lg:w-11 lg:h-11 rounded-xl lg:rounded-2xl text-slate-500 hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all shadow-2xs cursor-pointer"
              >
              ...
              <button
                onClick={() => navigate('/profile')}
                title="View Profile"
                className="hidden md:flex items-center gap-2.5 lg:gap-3 px-3 py-1.5 lg:px-4 lg:py-2 rounded-xl lg:rounded-2xl border border-slate-200/80 bg-white text-slate-900 hover:border-blue-300 hover:shadow-sm transition-all text-left group cursor-pointer"
              >
              ...
              <button
                ...
                className="md:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-slate-100 text-slate-700 hover:opacity-80 transition-colors"
